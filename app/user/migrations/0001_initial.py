    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=255, unique=True, validators=[django.core.validators.MinLengthValidator(3)], verbose_name='Nome de usuário')),
                ...
                ('stations_to_notify', models.ManyToManyField(blank=True, related_name='notified_users', to='device.device')),
